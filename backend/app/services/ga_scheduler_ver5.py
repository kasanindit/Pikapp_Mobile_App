...
def validate_problem_feasibility(
    ...
    if config.max_bsu_per_day < 1:
        raise ValueError("Maksimal BSU per hari harus minimal 1.")
...
#     coverage_penalty /= total_days
#     capacity_penalty /= total_days
#     max_bsu_penalty /= total_days
#     kecamatan_penalty /= total_days
...
#         max_bsu_penalty=max_bsu_penalty,
#         kecamatan_penalty=kecamatan_penalty,
#         volume_balance_penalty=volume_balance_penalty,
#         total_penalty=total_penalty,
#         fitness=fitness,
#     )
